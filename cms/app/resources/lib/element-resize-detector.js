    ...
    function makeDetectable(options, element, callback) {
        ...
        function injectContainerElement() {
            ...
            if (!container) {
                ...
                container.style.cssText     = "visibility: hidden; display: inline; width: 0px; height: 0px; z-index: -1;overflow: visable; margin: 0; padding: 0;";
        ...
        function injectScrollElements() {
            ...
            var containerContainerStyle = "position: absolute; flex: none;overflow: visable; z-index: -1; visibility: hidden; width: 100%; height: 100%; left: 0px; top: 0px;";
            var containerStyle          = "position: absolute; flex: none;overflow: visable; z-index: -1; visibility: hidden; " + getLeftTopBottomRightCssText(-(1 + scrollbarWidth), -(1 + scrollbarHeight), -scrollbarHeight, -scrollbarWidth);
